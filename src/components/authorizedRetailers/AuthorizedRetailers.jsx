...
import styles from './authorizedRetailers.css'
  ...
  return (
    <>
            ...
            <div className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-9deb8a0" data-id="9deb8a0" data-element_type="column">
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  <div className="vapetasia-element vapetasia-element-91eeb0d vapetasia-widget-divider--view-line vapetasia-widget vapetasia-widget-divider" data-id="91eeb0d" data-element_type="widget" data-widget_type="divider.default">
      ...
      <section className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-1043a129 vapetasia-section-stretched vapetasia-section-full_width vapetasia-section-height-default vapetasia-section-height-default" data-id="1043a129" data-element_type="section" data-settings="{&quot;stretch_section&quot;:&quot;section-stretched&quot;}">
        <div className="vapetasia-container vapetasia-column-gap-default">
          <div className="vapetasia-row">
            <div className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-7e61448e" data-id="7e61448e" data-element_type="column">
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  <div className="vapetasia-element vapetasia-element-26ada692 vapetasia-widget vapetasia-widget-html" data-id="26ada692" data-element_type="widget" data-widget_type="html.default">
                    <div className="vapetasia-widget-container"> 
                      <a className="action-button-main locator" href="/store-locator" title="Find A Vapetasia-Authorized Retailer">
                        ...
                        <span className="action-content locator"> 
                          <span className="hide-on-hover"> 
                            <span className="hide-on-mobile">Find an authorized retailer</span> 
                            <span className="show-on-mobile">Store locator</span> 
                          </span> 
                          <span className="show-on-hover">Store locator</span> 
                        </span> 
                      </a>
                    </div>
                  </div>
