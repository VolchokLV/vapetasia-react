...
const Footer = () => {
  return (
    <>
      <div data-vapetasia-type="footer" data-vapetasia-id="1644" className="vapetasia vapetasia-1644 vapetasia-location-footer">
        <div className="vapetasia-section-wrap">
          <section className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-50cca8e vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default" data-id="50cca8e" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
            <div className="vapetasia-container vapetasia-column-gap-default">
              <div className="vapetasia-row">
                <div className="vapetasia-column vapetasia-col-25 vapetasia-top-column vapetasia-element vapetasia-element-1ccacb9" data-id="1ccacb9" data-element_type="column">
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap mobile-footer-top-pad">
                      <div className="vapetasia-element vapetasia-element-b446fdf vapetasia-widget vapetasia-widget-theme-site-logo vapetasia-widget-image" data-id="b446fdf" data-element_type="widget" data-widget_type="theme-site-logo.default">
                    ...
                    <div className="vapetasia-element vapetasia-element-e835f88 vapetasia-shape-circle vapetasia-grid-0 e-grid-align-center vapetasia-widget vapetasia-widget-social-icons vapetasia-footer-socials" data-id="e835f88" data-element_type="widget" data-widget_type="social-icons.default">
                      <div className="vapetasia-widget-container">
                        ...
                        <a className="vapetasia-icon vapetasia-social-icon vapetasia-social-icon-facebook vapetasia-repeater-item-57ec9d8" href="https://www.facebook.com/vapetasia/" target="_blank"> 
                        <span className="vapetasia-screen-only">Facebook</span> 
                        <i className="fab fa-facebook"></i> </a> 
                        </span> 
                        <span className="vapetasia-grid-item"> 
                        <a className="vapetasia-icon vapetasia-social-icon vapetasia-social-icon-instagram vapetasia-repeater-item-24cadd5" href="https://instagram.com/vapetasia" target="_blank"> 
                        <span className="vapetasia-screen-only">Instagram</span> 
                        <i className="fab fa-instagram"></i> </a> </span> 
                        <span className="vapetasia-grid-item"> 
                        <a className="vapetasia-icon vapetasia-social-icon vapetasia-social-icon-twitter vapetasia-repeater-item-beabc5f" href="https://twitter.com/vapetasia" target="_blank"> 
                        <span className="vapetasia-screen-only">Twitter</span> 
                        <i className="fab fa-twitter"></i> </a> </span>
                      </div>
                    </div>
                  </div>
                  <div className="vapetasia-element vapetasia-element-23a1eaf vapetasia-widget vapetasia-widget-text-editor" data-id="23a1eaf" data-element_type="widget" data-widget_type="text-editor.default">
                    <div className="vapetasia-widget-container">
                  ...
                  <div className="vapetasia-element vapetasia-element-bf8ffee vapetasia-widget vapetasia-widget-spacer" data-id="bf8ffee" data-element_type="widget" data-widget_type="spacer.default">
                    <div className="vapetasia-widget-container">
              ...
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  <div className="vapetasia-element vapetasia-element-cdace32 vapetasia-widget vapetasia-widget-heading" data-id="cdace32" data-element_type="widget" data-widget_type="heading.default">
                    <div className="vapetasia-widget-container">
                      <h2 className="vapetasia-heading-title vapetasia-size-default">Company</h2>
                    </div>
                  </div>
            ...
            <div className="vapetasia-column vapetasia-col-25 vapetasia-top-column vapetasia-element vapetasia-element-41b87b2" data-id="41b87b2" data-element_type="column">
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  <div className="vapetasia-element vapetasia-element-b56f604 vapetasia-widget vapetasia-widget-heading" data-id="b56f604" data-element_type="widget" data-widget_type="heading.default">
                    <div className="vapetasia-widget-container">
                      <h2 className="vapetasia-heading-title vapetasia-size-default">Let's Stay in touch!</h2>
                    </div>
                  </div>
                  <div className="vapetasia-element vapetasia-element-2ae88b2 vapetasia-widget vapetasia-widget-heading" data-id="2ae88b2" data-element_type="widget" data-widget_type="heading.default">
                    <div className="vapetasia-widget-container">
                      <h2 className="vapetasia-heading-title vapetasia-size-default">sign up for our Newsletter</h2>
                    </div>
                  </div>
