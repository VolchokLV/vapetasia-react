...
const AdvocacyHero = (props) => {
  ...
  return (
    <>
      <section className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-AdvocacyHero vapetasia-hidden-tablet vapetasia-hidden-phone vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default" data-id="AdvocacyHero" data-element_type="section" data-settings="{&quot;background_background&quot;:&quot;classic&quot;}">
        ...
        <div className="vapetasia-container vapetasia-column-gap-no">
          <div className="vapetasia-row">
            <div className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-9cefbfe" data-id="9cefbfe" data-element_type="column">
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  <div className="vapetasia-element vapetasia-element-8cc3ccf vapetasia-widget vapetasia-widget-spacer" data-id="8cc3ccf" data-element_type="widget" data-widget_type="spacer.default">
                  ...
                  <div className="vapetasia-element vapetasia-element-6ecbbaf vapetasia-widget vapetasia-widget-spacer" data-id="6ecbbaf" data-element_type="widget" data-widget_type="spacer.default">
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-spacer">
                        <div className="vapetasia-spacer-inner">
                        </div>
                  ...
                  <div className="force-visible vapetasia-element vapetasia-element-c8bed25 vapetasia-invisible vapetasia-widget vapetasia-widget-heading" data-id="c8bed25" data-element_type="widget" data-settings="{&quot;_animation&quot;:&quot;fadeInDown&quot;}" data-widget_type="heading.default">
                    <div className="vapetasia-widget-container">
                  ...
                  <div className="force-visible vapetasia-element vapetasia-element-1d181d7 vapetasia-invisible vapetasia-widget vapetasia-widget-heading" data-id="1d181d7" data-element_type="widget" data-settings="{&quot;_animation&quot;:&quot;fadeInUp&quot;}" data-widget_type="heading.default">
                    <div className="vapetasia-widget-container">
                      <h2 className="vapetasia-heading-title vapetasia-size-default">
                        {props.bottom}
                      </h2>
                  ...
                  <section className="vapetasia-section vapetasia-inner-section vapetasia-element vapetasia-element-AdvocacyHero vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default" data-id="AdvocacyHero" data-element_type="section">
                    <div className="vapetasia-container vapetasia-column-gap-default">
                      <div className="vapetasia-row">
                        ...
                        <div className="vapetasia-column vapetasia-col-33 vapetasia-inner-column vapetasia-element vapetasia-element-f640ba9" data-id="f640ba9" data-element_type="column">
                          <div className="vapetasia-column-wrap vapetasia-element-populated">
                            <div className="vapetasia-widget-wrap">
