...
const Navigation = () => {
  ...
  return (
      ...
      <div id="site-header-inner" className="clr container">
        ...
        <div id="site-navigation-wrap" className="clr">
          <nav id="site-navigation" className="navigation main-navigation clr" itemScope="itemscope" itemType="https://schema.org/SiteNavigationElement" role="navigation">
            ...
            <ul id="menu-main-nav-bar-menu" className="main-menu dropdown-menu sf-menu">
              ...
              <li id="menu-item-652" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown menu-item-652 nav-no-click">
                ...
                <ul className="sub-menu">
                  <li id="menu-item-619" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-619">
                    <a href={ process.env.REACT_APP_BASE_URL + '/category/eliquid/size/100ml'} className="menu-link">
                      <span className="text-wrap">
                        E-LIQUID 100ml
                      </span>
                    </a>
                  </li>
                  <li id="menu-item-2279" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2279">
                    <a href={ process.env.REACT_APP_BASE_URL + '/category/eliquid/size/60ml' } className="menu-link">
                      <span className="text-wrap">
                        E-LIQUID 60ml
                      </span>
                    </a>
                  ...
                  <li id="menu-item-655" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-655">
                    <a href={ process.env.REACT_APP_BASE_URL + '/category/salt/size/30ml'} className="menu-link">
                      <span className="text-wrap">
                        SALT 30ml
                      </span>
                    </a>
              ...
              <li id="menu-item-292" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-292">
                <a href={ process.env.REACT_APP_BASE_URL + '/advocacy/' } className="menu-link">
                  <span className="text-wrap">
                    ADVOCACY
                  </span>
                </a>
              ...
              <li id="menu-item-331" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-331">
                <a href={ process.env.REACT_APP_BASE_URL + '/about-us/' } className="menu-link">
                  <span className="text-wrap">
                    ABOUT US
                  </span>
                </a>
              ...
              <li id="menu-item-336" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children dropdown menu-item-336 nav-no-click">
                <a href={ process.env.REACT_APP_BASE_URL + '/contact/' } className="menu-link">
                  <span className="text-wrap">
                    CONTACT US<i className="nav-arrow fa fa-angle-down" aria-hidden="true" role="img"></i>
                  </span>
                </a>
                <ul className="sub-menu">
                  <li id="menu-item-1980" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-1980">
                    <a href={ process.env.REACT_APP_BASE_URL + '/contact/'} className="menu-link">
                      <span className="text-wrap">
                        CONTACT
                      </span>
                  ...
                  <li id="menu-item-2445" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2445">
                    <a href={ process.env.REACT_APP_BASE_URL + '/promotional-request/' } className="menu-link">
                      <span className="text-wrap">
                        PROMOTIONAL REQUEST
                      </span>
                    </a>
                  </li>
                  <li id="menu-item-2787" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2787">
                    <a href={ process.env.REACT_APP_BASE_URL + '/wholesale-registration/' } className="menu-link">
                      <span className="text-wrap">
                        WHOLESALE REGISTRATION
                      </span>
                    </a>
                  </li>
                  <li id="menu-item-4966" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-4966">
                    <a href={ process.env.REACT_APP_BASE_URL + '/contact-support/' }className="menu-link">
                      <span className="text-wrap">
                        CONTACT SUPPORT
                      </span>
                    </a>
            ...
            <li id="menu-item-2305" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2305">
              <a href={ process.env.REACT_APP_BASE_URL + '/wholesale/' } className="menu-link">
                <span className="text-wrap">
                  WHOLESALE
                </span>
              </a>
            ...
            <li id="menu-item-539" className="menu-item menu-item-type-post_type menu-item-object-page menu-item-539">
              <a href={ process.env.REACT_APP_BASE_URL + '/store-locator/' } className="menu-link">
                <span className="text-wrap">
                  STORE LOCATOR
                </span>
              </a>
    ...
    <div id="mobile-dropdown" className="clr">
      <nav className="clr" itemScope="itemscope" itemType="https://schema.org/SiteNavigationElement">
        <div id="mobile-nav" className="navigation clr">
            ...
            <ul id="menu-main-nav-bar-menu-1" className="menu">
              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-191 current_page_item menu-item-293">
                <a href={ process.env.REACT_APP_BASE_URL + '/' } aria-current="page">
                  HOME
                </a>
              </li>
              ...
              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-292">
                <a href={ process.env.REACT_APP_BASE_URL + '/advocacy/' }>ADVOCACY</a>
              </li>
              ...
              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-has-children menu-item-336">
                ...
                <ul className="sub-menu">
                  ...
                  <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-4966">
                    <a href={ process.env.REACT_APP_BASE_URL + '/contact-support/' }>CONTACT SUPPORT</a>
                  </li>
                </ul>
              </li>
              ...
              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-2305">
                <a href={ process.env.REACT_APP_BASE_URL + '/wholesale/' }>WHOLESALE</a>
              </li>


              <li className="menu-item menu-item-type-post_type menu-item-object-page menu-item-539">
                <a href={ process.env.REACT_APP_BASE_URL + '/store-locator/' }>STORE LOCATOR</a>
              </li>
