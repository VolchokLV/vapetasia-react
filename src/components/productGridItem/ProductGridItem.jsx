...
const ProductGridItem = (props) => {
  ...
  return (
    <div className="vapetasia-custom-grid-item">
      ...
      <div className="vapetasia-element vapetasia-element-ce2de18 vapetasia-widget vapetasia-widget-text-editor vapetasia-grid-item-wrapper" data-id="ce2de18" data-element_type="widget" data-widget_type="text-editor.default">
        <div className="vapetasia-widget-container">
