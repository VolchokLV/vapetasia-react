...
const ProductPopUp = (props) => {
  ...
  return (
    <div
      className={`${
        props.show ? "showProductModal" : "hideProductModal"
      } dialog-widget dialog-lightbox-widget dialog-type-buttons dialog-type-lightbox vapetasia-popup-modal`}
        ...
        <div className="dialog-message dialog-lightbox-message">
          <div className="showProductModal vapetasia vapetasia-5469 vapetasia-location-popup">
            <div className="vapetasia-section-wrap">
              ...
              >
                <div className="vapetasia-container vapetasia-column-gap-no">
                  <div className="vapetasia-row">
                    <div
                      className="vapetasia-column vapetasia-col-50 vapetasia-top-column vapetasia-element vapetasia-element-51fcf799"
                      data-id="51fcf799"
                    ...
                    >
                      <div className="vapetasia-column-wrap vapetasia-element-populated">
                        <div className="vapetasia-widget-wrap">
                          <div
                            className="vapetasia-element vapetasia-element-2ec666de vapetasia-widget vapetasia-widget-image"
                            data-id="2ec666de"
                    ...
                    <div
                      className="vapetasia-column vapetasia-col-50 vapetasia-top-column vapetasia-element vapetasia-element-42ee872a"
                      data-id="42ee872a"
                      data-element_type="column"
                    >
                      <div className="vapetasia-column-wrap vapetasia-element-populated">
                        <div className="vapetasia-widget-wrap">
                          ...
                          <div
                            className="vapetasia-element vapetasia-element-fb30aef vapetasia-widget vapetasia-widget-text-editor"
                            data-id="fb30aef"
                            data-element_type="widget"
              ...
              <section
                className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-7d52d324 vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default"
                data-id="7d52d324"
                data-element_type="section"
              >
                <div className="vapetasia-container vapetasia-column-gap-default">
                  <div className="vapetasia-row">
                    <div
                      className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-1c7d44a6"
                      data-id="1c7d44a6"
                      data-element_type="column"
                    >
                      <div className="vapetasia-column-wrap vapetasia-element-populated">
                        <div className="vapetasia-widget-wrap">
                          <div
                            className="vapetasia-element vapetasia-element-7644b471 vapetasia-widget vapetasia-widget-heading"
                            data-id="7644b471"
                            data-element_type="widget"
                            data-widget_type="heading.default"
                          >
                          ...
                          <div
                            className="vapetasia-element vapetasia-element-40fe6520 vapetasia-widget vapetasia-widget-text-editor"
                            data-id="40fe6520"
                            data-element_type="widget"
                            data-widget_type="text-editor.default"
                          >
                            <div className="vapetasia-widget-container">
                              <div className="vapetasia-text-editor vapetasia-clearfix">
                                <p>
                                  ...
                                  stock from one of our trusted distributors to
                                  ensure quality, and authenticity for every
                                  bottle of Vapetasia Eliquid.
                                </p>
                              </div>
                            </div>
                          </div>
              ...
              <section
                className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-2d92b12d vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default"
                data-id="2d92b12d"
                data-element_type="section"
              >
                <div className="vapetasia-container vapetasia-column-gap-default">
