...
const Advocacy = () => {
  return (
    <>
      ...
      <section className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-3e35151 vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default" data-id="3e35151" data-element_type="section">
        ...
        <div className="vapetasia-container vapetasia-column-gap-default">
            <div className="vapetasia-row">
              <div className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-e3124ce" data-id="e3124ce" data-element_type="column">
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap">
                        <div className="vapetasia-element vapetasia-element-c770e09 vapetasia-widget vapetasia-widget-heading" data-id="c770e09" data-element_type="widget" data-widget_type="heading.default">
                          <div className="vapetasia-widget-container">
                              <h2 className="vapetasia-heading-title vapetasia-size-default">WHAT IS ADVOCAcY AND WHY YOU SHOULD CARE.</h2>
                          </div>
                        </div>
                    </div>
                  </div>
        ...
        <div className="vapetasia-container vapetasia-column-gap-default">
            <div className="vapetasia-row">
              <div className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-037159a" data-id="037159a" data-element_type="column">
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap">
                        <div className="vapetasia-element vapetasia-element-4889dc5 vapetasia-widget vapetasia-widget-heading" data-id="4889dc5" data-element_type="widget" data-widget_type="heading.default">
                          <div className="vapetasia-widget-container">
                              <h2 className="vapetasia-heading-title vapetasia-size-default">HOW CAN YOU HELP?</h2>
                          </div>
                        </div>
                    </div>
                  </div>
      ...
      <section id="advocacy-section" className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-45d851e vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default" data-id="45d851e" data-element_type="section">
        <div className="vapetasia-container vapetasia-column-gap-default">
            <div className="vapetasia-row">
              <div className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-260c7c5" data-id="260c7c5" data-element_type="column">
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap">
                        <div className="vapetasia-element vapetasia-element-bb8c17a vapetasia-widget vapetasia-widget-heading" data-id="bb8c17a" data-element_type="widget" data-widget_type="heading.default">
                          <div className="vapetasia-widget-container">
                              <h2 className="vapetasia-heading-title vapetasia-size-default">DO YOUR PART!</h2>
                          </div>
                        </div>
      ...
      <section id="advocacy-section" className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-292d729 vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default" data-id="292d729" data-element_type="section">
        <div className="vapetasia-container vapetasia-column-gap-default">
            <div className="vapetasia-row">
              <div className="vapetasia-column vapetasia-col-33 vapetasia-top-column vapetasia-element vapetasia-element-aa9bc7f" data-id="aa9bc7f" data-element_type="column">
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap">
                        <div className="vapetasia-element vapetasia-element-6ada6b4 vapetasia-widget vapetasia-widget-image" data-id="6ada6b4" data-element_type="widget" data-widget_type="image.default">
                          <div className="vapetasia-widget-container">
                              <div className="vapetasia-image">
                                <img width="326" height="275" src="https://cdn2.vapetasia.com/img/advocacy/VTA.png" className="attachment-large size-large lazyload" alt="" sizes="(max-width: 326px) 100vw, 326px" />
                              </div>
                          </div>
                        </div>
                    </div>
              ...
              <div className="vapetasia-column vapetasia-col-66 vapetasia-top-column vapetasia-element vapetasia-element-749d4fe" data-id="749d4fe" data-element_type="column">
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap">
                        ...
                        <div className="vapetasia-element vapetasia-element-b339438 vapetasia-widget vapetasia-widget-button" data-id="b339438" data-element_type="widget" data-widget_type="button.default">
                          <div className="vapetasia-widget-container">
                              <div className="vapetasia-button-wrapper">
                                <a href="https://vaportechnology.org/" className="vapetasia-button-link vapetasia-button vapetasia-size-sm" role="button">
                                <span className="vapetasia-button-content-wrapper">
        ...
        <div className="vapetasia-container vapetasia-column-gap-default">
            <div className="vapetasia-row">
              <div className="vapetasia-column vapetasia-col-100 vapetasia-top-column vapetasia-element vapetasia-element-385c0c5" data-id="385c0c5" data-element_type="column">
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap">
                        <div className="vapetasia-element vapetasia-element-22e5651 vapetasia-widget-divider--view-line vapetasia-widget vapetasia-widget-divider" data-id="22e5651" data-element_type="widget" data-widget_type="divider.default">
                          <div className="vapetasia-widget-container">
                  ...
                  <div className="vapetasia-column-wrap vapetasia-element-populated">
                    <div className="vapetasia-widget-wrap">
                        <div className="vapetasia-element vapetasia-element-6ada6b4 vapetasia-widget vapetasia-widget-image" data-id="6ada6b4" data-element_type="widget" data-widget_type="image.default">
                          <div className="vapetasia-widget-container">
                              <div className="vapetasia-image">
                                <img width="326" height="275" src="https://cdn2.vapetasia.com/img/advocacy/CASAA.png" className="attachment-large size-large lazyload" alt="" sizes="(max-width: 326px) 100vw, 326px" />
                              </div>
                          </div>
                        </div>
                    </div>
