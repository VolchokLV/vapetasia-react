...
const Blog = () => {
  return (
    <>
                      ...
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          <span data-preserver-spaces="true">
                            New policies regarding vape related mail will go
                            into place within the next 90-120 days with the
                            signing of the massive&nbsp;
                          </span>
                          <a
                            href="https://www.washingtonpost.com/us-policy/2020/12/21/stimulus-congress/"
                            target="_blank"
                            rel="noopener"
                          >
                            omnibus spending, coronavirus relief package
                          </a>
      ...
      <section
        id="blog-section"
        className="vapetasia-section vapetasia-top-section vapetasia-element vapetasia-element-c5682bb vapetasia-section-boxed vapetasia-section-height-default vapetasia-section-height-default"
        data-id="c5682bb"
        data-element_type="section"
      >
        <div className="vapetasia-container vapetasia-column-gap-default">
          <div className="vapetasia-row">
            <div
              className="vapetasia-column vapetasia-col-33 vapetasia-top-column vapetasia-element vapetasia-element-fed1749"
              data-id="fed1749"
              data-element_type="column"
            >
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  <div
                    className="vapetasia-element vapetasia-element-9697175 vapetasia-widget vapetasia-widget-image"
                    data-id="9697175"
                    data-element_type="widget"
                    data-widget_type="image.default"
                  >
            ...
            <div
              className="vapetasia-column vapetasia-col-66 vapetasia-top-column vapetasia-element vapetasia-element-a78af99"
              data-id="a78af99"
              data-element_type="column"
            >
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  <div
                    className="vapetasia-element vapetasia-element-251a8a2 vapetasia-widget vapetasia-widget-spacer"
                    data-id="251a8a2"
                    data-element_type="widget"
                    data-widget_type="spacer.default"
                  >
                  ...
                  <div
                    className="vapetasia-element vapetasia-element-8b3e0c1 vapetasia-widget vapetasia-widget-heading"
                    data-id="8b3e0c1"
                    data-element_type="widget"
                    data-widget_type="heading.default"
                  >
                  ...
                  <div
                    className="vapetasia-element vapetasia-element-c3f8d0d vapetasia-widget vapetasia-widget-text-editor"
                    data-id="c3f8d0d"
                    data-element_type="widget"
                    data-widget_type="text-editor.default"
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          The California Coalition for Fairness has gathered
                          over a million signatures from registered voters in
                          the state of California that are opposed to the flavor
                          ban…
                        </p>
                      </div>
                    </div>
                  ...
                  <div
                    className="vapetasia-element vapetasia-element-fee27b6 vapetasia-align-center vapetasia-widget vapetasia-widget-button"
                    data-id="fee27b6"
                    data-element_type="widget"
                    data-widget_type="button.default"
                  >
                    ...
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-image">
                        <a
                          href={
                            process.env.REACT_APP_BASE_URL +
                            "/australian-vapers-oppose-the-prescription-model/"
                          }
                          className="no-lightbox"
                        >
                          <img
                ...
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          Australia has been unreasonable in regards to tobacco
                          harm reduction and so we urge Australian vapers oppose
                          the prescription model for smokeless nicotine
                          products.
                        </p>
                      </div>
                    </div>
              ...
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <h2 className="vapetasia-heading-title vapetasia-size-default">
                        Nova Scotia Canada Cigarette Sales Increase following
                        Flavor Ban
                      </h2>
                    </div>
                  </div>
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          Following the flavor ban in Nova Scotia Canada on
                          April 1, 2020 cigarette sales have seen an
                          unprecedented spike..
                        </p>
                      </div>
                    </div>
                ...
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          A new publication by the Cochrane Review shows
                          “moderate-certainty evidence” that smoking quit rates
                          were higher in participants using vaping products than
                          those assigned nicotine replacement therapy products.
                        </p>
                      </div>
                    </div>
                  </div>
              ...
              <div className="vapetasia-column-wrap vapetasia-element-populated">
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <h2 className="vapetasia-heading-title vapetasia-size-default">
                        Journal of the American Heart Association Retracts
                        Anti-Vaping Study
                      </h2>
                    </div>
                  </div>
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          Anti-Vaping study found unreliable and retracted!{" "}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          What is Prop EE? Prop EE is a tax introduced Colorado
                          which would increase the tax of nicotine-containing
                          vapor products starting in 2021 if voted in.{" "}
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          A vape tax has been introduced in Oregon which would
                          increase the tax on vape products by 65% of the
                          wholesale price.{" "}
                        </p>
                      </div>
                    </div>
                ...
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          With a flavor ban in Phoenix AZ being introduced to
                          the Phoenix City Council, we need to make our voices
                          heard.
                        </p>
                      </div>
                    </div>
                ...
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          Vapetasia would like to announce the successful
                          submission of our extensive and thorough Pre-Market
                          Tobacco Application.
                        </p>
                      </div>
                    </div>
                ...
                <div className="vapetasia-widget-wrap">
                  ...
                  >
                    <div className="vapetasia-widget-container">
                      <div className="vapetasia-text-editor vapetasia-clearfix">
                        <p>
                          Vape mail is a big thing for our industry especially
                          for people who have disabilities, health issues, or
                          live in rural areas that don’t have access to brick
                          and mortar stores.{" "}
                        </p>
                      </div>
                    </div>
