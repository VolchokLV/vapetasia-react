...
const Home = (props) => {
  return (
    <>
      <Hero top={'Premium Handcrafted'} bottom={'Award Winning E-Liquid'} paragraph={'We invest our energy and commitment to produce delicious, flavorful alternatives to combustible cigarettes.'}></Hero>
