...
const WholesaleRegistration = () => {
  return (
    <>
        <Hero heroClass="Wholesale" top={'Vapetasia'} bottom={'WHOLESALE REGISTRATION'} paragraph={'Please submit the form below and a sales ambassador will follow up with you as soon as possible.'}></Hero>
